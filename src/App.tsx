      ...
      <BrowserRouter>
        <Routes>
          ...
          >
            ...
            <Route path="maintenance/work-orders" element={<ProtectedRoute allowedRoles={['supervisor', 'admin']}><Suspense fallback={<PageLoader />}><WorkOrders /></Suspense></ProtectedRoute>} />
